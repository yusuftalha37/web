...
const Store = (() => {
  ...
  function fromDbSlide(r) { return { id: r.id, image: r.image || "", imgPos: r.imgPos || "50% 50%", art: r.art, title: r.title, subtitle: r.subtitle || "", btnText: r.btnText || "", btnLink: r.btnLink || "urunler.html" }; }
